...
type BackendClient interface {
	...
	AudioTranscriptionStream(ctx context.Context, in *TranscriptRequest, opts ...grpc.CallOption) (Backend_AudioTranscriptionStreamClient, error)
	...
	AudioTransformStream(ctx context.Context, opts ...grpc.CallOption) (Backend_AudioTransformStreamClient, error)
	...
	AudioToAudioStream(ctx context.Context, opts ...grpc.CallOption) (Backend_AudioToAudioStreamClient, error)
	...
	Forward(ctx context.Context, opts ...grpc.CallOption) (Backend_ForwardClient, error)
}
...
func (c *backendClient) AudioTranscriptionStream(ctx context.Context, in *TranscriptRequest, opts ...grpc.CallOption) (Backend_AudioTranscriptionStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[1], Backend_AudioTranscriptionStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &backendAudioTranscriptionStreamClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Backend_AudioTranscriptionStreamClient interface {
	Recv() (*TranscriptStreamResponse, error)
	grpc.ClientStream
}

type backendAudioTranscriptionStreamClient struct {
	grpc.ClientStream
}

func (x *backendAudioTranscriptionStreamClient) Recv() (*TranscriptStreamResponse, error) {
	m := new(TranscriptStreamResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *backendClient) TTSStream(ctx context.Context, in *TTSRequest, opts ...grpc.CallOption) (Backend_TTSStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[2], Backend_TTSStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *backendClient) AudioTransformStream(ctx context.Context, opts ...grpc.CallOption) (Backend_AudioTransformStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[3], Backend_AudioTransformStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &backendAudioTransformStreamClient{ClientStream: stream}
	return x, nil
}

type Backend_AudioTransformStreamClient interface {
	Send(*AudioTransformFrameRequest) error
	Recv() (*AudioTransformFrameResponse, error)
	grpc.ClientStream
}

type backendAudioTransformStreamClient struct {
	grpc.ClientStream
}

func (x *backendAudioTransformStreamClient) Send(m *AudioTransformFrameRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *backendAudioTransformStreamClient) Recv() (*AudioTransformFrameResponse, error) {
	m := new(AudioTransformFrameResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *backendClient) AudioToAudioStream(ctx context.Context, opts ...grpc.CallOption) (Backend_AudioToAudioStreamClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[4], Backend_AudioToAudioStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &backendAudioToAudioStreamClient{ClientStream: stream}
	return x, nil
}

type Backend_AudioToAudioStreamClient interface {
	Send(*AudioToAudioRequest) error
	Recv() (*AudioToAudioResponse, error)
	grpc.ClientStream
}

type backendAudioToAudioStreamClient struct {
	grpc.ClientStream
}

func (x *backendAudioToAudioStreamClient) Send(m *AudioToAudioRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *backendAudioToAudioStreamClient) Recv() (*AudioToAudioResponse, error) {
	m := new(AudioToAudioResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *backendClient) FineTuneProgress(ctx context.Context, in *FineTuneProgressRequest, opts ...grpc.CallOption) (Backend_FineTuneProgressClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[5], Backend_FineTuneProgress_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *backendClient) QuantizationProgress(ctx context.Context, in *QuantizationProgressRequest, opts ...grpc.CallOption) (Backend_QuantizationProgressClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[6], Backend_QuantizationProgress_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *backendClient) Forward(ctx context.Context, opts ...grpc.CallOption) (Backend_ForwardClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Backend_ServiceDesc.Streams[7], Backend_Forward_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &backendForwardClient{ClientStream: stream}
	return x, nil
}

type Backend_ForwardClient interface {
	Send(*ForwardRequest) error
	Recv() (*ForwardReply, error)
	grpc.ClientStream
}

type backendForwardClient struct {
	grpc.ClientStream
}

func (x *backendForwardClient) Send(m *ForwardRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *backendForwardClient) Recv() (*ForwardReply, error) {
	m := new(ForwardReply)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type BackendServer interface {
	...
	AudioTranscriptionStream(*TranscriptRequest, Backend_AudioTranscriptionStreamServer) error
	...
	AudioTransformStream(Backend_AudioTransformStreamServer) error
	// AudioToAudioStream is the bidirectional any-to-any S2S RPC. Backends
	// that load a speech-to-speech model consume input audio frames and emit
	// interleaved audio + transcript + tool-call deltas as typed events.
	// Backends without S2S support return UNIMPLEMENTED.
	AudioToAudioStream(Backend_AudioToAudioStreamServer) error
	...
	// body chunks (SSE frames or chunked transfer). Cancellation of the
	// gRPC context closes the upstream connection.
	Forward(Backend_ForwardServer) error
...
func (UnimplementedBackendServer) AudioTranscriptionStream(*TranscriptRequest, Backend_AudioTranscriptionStreamServer) error {
...
func (UnimplementedBackendServer) AudioTransformStream(Backend_AudioTransformStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method AudioTransformStream not implemented")
}
func (UnimplementedBackendServer) AudioToAudioStream(Backend_AudioToAudioStreamServer) error {
...
func (UnimplementedBackendServer) Forward(Backend_ForwardServer) error {
...
func _Backend_AudioTranscriptionStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BackendServer).AudioTranscriptionStream(m, &backendAudioTranscriptionStreamServer{ServerStream: stream})
}

type Backend_AudioTranscriptionStreamServer interface {
	Send(*TranscriptStreamResponse) error
	grpc.ServerStream
}

type backendAudioTranscriptionStreamServer struct {
	grpc.ServerStream
}

func (x *backendAudioTranscriptionStreamServer) Send(m *TranscriptStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
func _Backend_AudioTransformStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BackendServer).AudioTransformStream(&backendAudioTransformStreamServer{ServerStream: stream})
}

type Backend_AudioTransformStreamServer interface {
	Send(*AudioTransformFrameResponse) error
	Recv() (*AudioTransformFrameRequest, error)
	grpc.ServerStream
}

type backendAudioTransformStreamServer struct {
	grpc.ServerStream
}

func (x *backendAudioTransformStreamServer) Send(m *AudioTransformFrameResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *backendAudioTransformStreamServer) Recv() (*AudioTransformFrameRequest, error) {
	m := new(AudioTransformFrameRequest)
...
func _Backend_AudioToAudioStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BackendServer).AudioToAudioStream(&backendAudioToAudioStreamServer{ServerStream: stream})
}

type Backend_AudioToAudioStreamServer interface {
	Send(*AudioToAudioResponse) error
	Recv() (*AudioToAudioRequest, error)
	grpc.ServerStream
}

type backendAudioToAudioStreamServer struct {
	grpc.ServerStream
}

func (x *backendAudioToAudioStreamServer) Send(m *AudioToAudioResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *backendAudioToAudioStreamServer) Recv() (*AudioToAudioRequest, error) {
	m := new(AudioToAudioRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func _Backend_Forward_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BackendServer).Forward(&backendForwardServer{ServerStream: stream})
}

type Backend_ForwardServer interface {
	Send(*ForwardReply) error
	Recv() (*ForwardRequest, error)
	grpc.ServerStream
}

type backendForwardServer struct {
	grpc.ServerStream
}

func (x *backendForwardServer) Send(m *ForwardReply) error {
	return x.ServerStream.SendMsg(m)
}

func (x *backendForwardServer) Recv() (*ForwardRequest, error) {
